...
const questions = [
  ...
  {
    question: 'Apa output dari System.out.println("Hello, World!"); dalam Java?',
    options: ['Hello, World!', 'Hello World!', 'Hello', 'World!'],
    correctAnswer: 'Hello, World!'
  },
  {
    question: 'Apa hasil dari 8 / 2 dalam Java?',
    options: ['3', '4', '2', '0'],
    correctAnswer: '4'
  },
  {
    question: 'Apa yang dilakukan oleh operator "++x;" dalam Java?',
  ...
  {
    question: 'Apa output dari System.out.println((5 + 3) * 2); dalam Java?',
    options: ['16', '10', '26', '8'],
    correctAnswer: '16'
  },
  {
    question: 'Apa yang dilakukan oleh pernyataan "import java.util.*;" dalam Java?',
    options: ['Mengimpor semua kelas dari package java.util', 'Mengimpor kelas tertentu dari package java.util', 'Mengabaikan package java.util', 'Membuat package baru'],
    correctAnswer: 'Mengimpor semua kelas dari package java.util'
  },
  {
    question: 'Apa yang dilakukan pernyataan "Scanner scanner = new Scanner(System.in);" dalam Java?',
    options: ['Membuat objek Scanner untuk menerima input dari pengguna', 'Mencetak output ke layar', 'Mengimport kelas Scanner dari package System.in', 'Mendeklarasikan variabel scanner'],
    correctAnswer: 'Membuat objek Scanner untuk menerima input dari pengguna'
  },
  {
    question: 'Apa yang dilakukan pernyataan "int numbers[] = new int[5];" dalam Java?',
  ...
  {
    question: 'Apa yang dilakukan pernyataan "System.out.println(numbers[2]);" dalam Java?',
  ...
  {
    question: 'Apa yang dilakukan pernyataan "int x = 5, y = 3;" dalam Java?',
  ...
  {
    question: 'Apa yang dilakukan pernyataan "if (x > y) { System.out.println("x lebih besar dari y"); }" dalam Java?',
  ...
  {
    question: 'Apa yang dilakukan pernyataan "for (int i = 0; i < 5; i++) { System.out.print(i); }" dalam Java?',
  ...
  {
    question: 'Apa yang dilakukan pernyataan "while (x < 10) { x++; }" dalam Java?',
  ...
  {
    question: 'Apa yang dilakukan pernyataan "switch (x) { case 1: System.out.println("Satu"); break; case 2: System.out.println("Dua"); break; default: System.out.println("Bukan satu atau dua"); }" dalam Java?',
  ...
  {
    question: 'Apa yang dilakukan pernyataan "int[] numbers = {1, 2, 3, 4, 5};" dalam Java?',
    options: ['Membuat array dengan 5 elemen dan memberi nilai awal 1, 2, 3, 4, dan 5', 'Membuat variabel bernama numbers dengan nilai 1, 2, 3, 4, dan 5', 'Membuat pointer ke variabel numbers', 'Membuat variabel global dengan 5 elemen'],
    correctAnswer: 'Membuat array dengan 5 elemen dan memberi nilai awal 1, 2, 3, 4, dan 5'
  },
  {
    question: 'Apa yang dilakukan pernyataan "int add(int a, int b) { return a + b; }" dalam Java?',
...
export default function QuizJava({ navigation }) {
  ...
  if (showResult) {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('CertificateJava')}>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.back}>
          ...
          <Text style={styles.text1}>Quiz Java</Text>
      </View>
